 ...
 *
 * This class provides basic matrix operations (addition, subtraction, multiplication, etc.) as overloaded operators.
 * This does not include more advanced operations like inverse, or matrix decompositions.
 *
...
public:
     ...
     */
    explicit Matrix(size_t size = 1);

    /** 
     * \brief General Matrix constructor
     *
     * This constructor creates a matrix of the specified size.
     * The number of rows and columns is specified and must be positive integers.
     *
 ...
 * Division by a scalar, s, is essentially the same as multiplication (or scaling) by 1/s.
