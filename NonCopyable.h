 ...
 * technical reasons (such as the class representing a limited physical resource),
 * and sometimes for practical reasons (such as the class storing lots of information).
 * In C++ this can be enforced by explicitly deleting the copy constructor and assignment 
 * operator, or by making them private.
 * The NonCopyable class makes this easy and less error prone to do. To make a
...
public:
     ...
     */
    NonCopyable(const NonCopyable & /**< NOT USED*/) = delete;
     ...
     */
    NonCopyable &operator=(const NonCopyable & /**< NOT USED*/) = delete;
